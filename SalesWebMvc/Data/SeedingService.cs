...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3000.0, d2);
            Seller s3 = new Seller(3, "Divina", "divinamaria.castro.10@gmail.com", new DateTime(1957, 10, 30), 2000.0, d1);
            Seller s4 = new Seller(4, "Luis Paulo", "luis.paulo@escolarmanager.com", new DateTime(1988, 7, 7), 1000.0, d4);
            Seller s5 = new Seller(5, "Isabella", "Isabella.10@gmail.com", new DateTime(2015, 9, 4), 5000.0, d3);
            Seller s6 = new Seller(6, "Maria Julia", "Julia.10@gmail.com", new DateTime(2012, 12, 4), 4000.0, d2);
